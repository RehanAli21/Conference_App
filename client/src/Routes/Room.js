...
// 	let { ready, tracks } = useMicrophoneAndCameraTracks()
...
// 	const ScreenShare = () => {
// 		let { screenReady, screenTracks } = useScreenVideoTrack()
...
// 					</div>
// 					<div className='icon' style={{ backgroundColor: screen ? 'blueviolet' : '' }} onClick={ScreenShare}>
